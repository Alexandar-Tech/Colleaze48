...
// import MulticolorBarChartExample from './BarChart';
import ComingSoon from '../ComingSoon/ComingSoon';

export function MyPerformance({props,navigation}) {
    return(
        <>
        <LinearGradient
                    ...
                    <View style={styles.headerPad}>
                        ...
                        {/* <View style={styles.boxpad}>
                            <View style={{margin:10}}>
                                <DropdownComponent name={'Select Class'}/>
                            </View>
                            <View style={{margin:10}}>
                                <DropdownComponent name={'Select Subject'}/>
                            </View>
                            <View style={{margin:10}}>
                                <DropdownComponent name={'Select Section'}/>
                            </View>
                            <View>
                                <Text style={styles.textcss}>Overall Attendance 2022-23</Text>
                                <MulticolorBarChartExample />                                
                            </View>
                        </View> */}
                    </View>
